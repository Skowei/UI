...
class UpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = "sk/ui:update {ver=blade} {--force=false}";
     ...
     * @var string
     */
    protected $description = "update skowei ui package";
    ...
    private function UpdateBlade()
    {
        ...
        $this->info("");
            ...
            Artisan::call('vendor:publish --tag=sk-ui-blade '.$forced);
    ...
    private function StartInfo()
    {
        if($this->option("force")){
            ...
            $this->info("<bg=magenta>      UPDATING SKOWEI UI PACKAGE      ");
            $this->info("<fg=magenta>======================================");
        }else{
            $this->info("<fg=magenta>======================================");
